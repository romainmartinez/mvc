...
Consequently, previous studies have identified optimal combinations of MVIC tests that produce near-to-maximum EMG activation levels on the shoulder complex [@dalmaso_optimal_2016].
...
# Methods
The sample included 152 participants that volunteered to nine shoulder EMG-based experiments. A diversity of 16 MVIC tests and 11 muscles were recorded.
...
# Results
Five MVIC tests were retained. The optimized extra-trees regressor predicts values with a global RMSE and R2 equal to 10% and 0.95, respectively.
For each muscle, the predicted MVA was not significantly different from the MVA produced by previously identified optimal combinations (p>0.05).
